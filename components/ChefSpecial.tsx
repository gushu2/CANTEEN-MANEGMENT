...
const ChefSpecial: React.FC = () => {
    ...
    return (
        <div className="mb-8 p-6 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg text-white relative overflow-hidden">
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-white/10 rounded-full"></div>
            <div className="absolute -bottom-8 -left-2 w-32 h-32 bg-white/10 rounded-full"></div>
            <div className="relative z-10">
                <div className="flex items-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-yellow-300 mr-2" viewBox="0 0 20 20" fill="currentColor">
